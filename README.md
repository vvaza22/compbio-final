...
3.  **Convolutional Tower**: რეზიდუალურ კონვოლუციურ ბლოკებს უფრო მეტად ამოაქვთ ინფორმაცია
4.  **Embedding for Transformer**: წინა მოდელის ანალოგიურად
5.  **Positional Encoding**: წინა მოდელის ანალოგიურად
6.  **Transformer Encoder**: წინა მოდელის ანალოგიურად
7.  **Aggregation**: `[CLS]`-ის მაგივრად ვიყენებ 2 მეთოდს: mean ან max pooling, რათა მივიღო საბოლოო შეჯამებული ან საუკეთესო ვექტორი
8.  **Prediction Head**: ეს საბოლოო შეჯამებული ვექტორი გადის feed-forward ქსელში, რათა გამოითვალოს ბმის ქულა
